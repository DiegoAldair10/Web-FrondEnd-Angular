...
@Component({
  selector: 'app-paginator-facturas',
  templateUrl: './paginator-facturas.component.html',
  styleUrls: ['./paginator-facturas.component.css']
})
export class PaginatorFacturasComponent implements OnInit {
  @Input() paginador: any;
